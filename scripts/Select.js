...
class Select extends BaseComponent {
	...
	updateUI() {
		...
		const updateButton = () => {
			...
			this.buttonElement.setAttribute(
				this.setAttributes.ariaExpanded,
				isExpanded
			)
			this.buttonElement.setAttribute(
				this.setAttributes.ariaActiveDescendant,
		...
		const updateOptions = () => {
			this.optionElements.forEach((optionElement, index) => {
				...
				optionElement.setAttribute(this.setAttributes.ariaSelected, isSelected)
			})
		}
	...
	bindEvents() {
		MatchMedia.mobile.addEventListener('change', this.onMobileMathMediaChange)
